...
//
//     plutil -convert json -r -o $GOPATH/src/github.com/justinkiang/hc/gen/metadata.json /Applications/HomeKit\ Accessory\ Simulator.app/Contents/Frameworks/HAPAccessoryKit.framework/Versions/A/Resources/default.metadata.plist
package main

import (
	"encoding/json"
	"github.com/justinkiang/hc/gen"
	"github.com/justinkiang/hc/gen/golang"
	"io/ioutil"
	"log"
	"os"
	"os/exec"
...
var LibPath = os.ExpandEnv("$GOPATH/src/github.com/justinkiang/hc")
